...
class ReadWorkSetupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ref_name = "system_management.work_setup.id.ReadWorkSetupSerializer"
        model = WorkSetup
        fields = [
            'id',
            'work_setup',
...
class UpdateWorkSetupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ref_name = "system_management.work_setup.id.UpdateWorkSetupSerializer"
        model = WorkSetup
        fields = [
            'work_setup',
        ]
...
class DeleteWorkSetupSerializer(serializers.Serializer): # noqa
    ...
    class Meta:
        ref_name = "system_management.work_setup.id.DeleteWorkSetupSerializer"
